<div id="page-wrapper">
	<div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				<h2>Eidt job</h2>
				<h5>Edit the time on and off the connected devices</h5>
			</div>
		</div>
		<!-- /. ROW  -->
		<hr />
		<?php echo form_open('scheduler/doSimpleEdit'); ?>
		<input type="hidden" name="id_cron" id="id_cron" value="<?php echo $id_cron; ?>">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Hours</label> <select class="form-control" name="hstart" id="hstart">
										<option selected><?php echo $hstart;?></option>
										<option>00</option>
										<option>01</option>
										<option>02</option>
										<option>03</option>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<option selected><?php echo $mstart;?></option>
										<option>00</option>
										<option>01</option>
										<option>02</option>
										<option>03</option>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<option selected><?php echo $hstop;?></option>
										<option>00</option>
										<option>01</option>
										<option>02</option>
										<option>03</option>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<option selected><?php echo $mstop;?></option>
										<option>00</option>
										<option>01</option>
										<option>02</option>
										<option>03</option>
